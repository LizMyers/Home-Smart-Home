...
/**********************************************************************************
   From Sid's Classroom  https://youtu.be/xi9ZMFipaSA
   Control NeoPixel Ring with NodeMCU
 *********************************************************************************/
#include <Arduino.h>
...
#define WIFI_SSID "YOUR WIFI NAME"//Set your Wifi name
#define WIFI_PASS "YOUR WIFI PASSWORD"//Set your Wifi Password
#define SERIAL_BAUDRATE                 115200

fauxmoESP fauxmo;
//declare switching pins
//#define RGBCTL D1 //generic NODE MCU
#define RGBCTL 14 //Huzzah Feather
...
void callback(uint8_t device_id, const char * device_name, bool state) {
  ...
  if ( (strcmp(device_name, "GOOGLE LIGHTS") == 0) ) {
    ...
    //Turns strip into White Snowflale
